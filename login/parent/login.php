...
_END;
		 ...
		 {
		     $query = "SELECT * FROM parents WHERE phone='$username'";
		     $query2 = "SELECT * FROM parents WHERE email='$username'";
			 ...
			 elseif (mysql_num_rows($result))
			 {
				 ...
				 if($password == $row[8])
				 {
				     ...
				     $_SESSION['parent_firstname'] = $row[1];
					 $_SESSION['parent_lastname'] = $row[2];
					 $_SESSION['gender'] = $row[3];
					 $_SESSION['address'] = $row[4];
					 $_SESSION['phone'] = $row[5];
					 $_SESSION['phone_alt'] = $row[6];
