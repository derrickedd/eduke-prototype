...
<body>
	 ...
	 <div id="footer">
	  ...
	  <script>
		 ...
		 function moreHouses(value){
			 $.ajax({
				 type:"post",
				 url:"house-process-function.php",
				 data:"page="+value+"&action=showhouselist",
				 success:function(data){
					 $("#list-results").html(data);
				 }
			 });
		 ...
		 function deleteHouse(house_id){
			 if (confirm('Are you sure you want to delete the house?')) {
				 $.ajax({
					 type:"post",
					 url:"house-process-function.php",
					 data:"house_id="+house_id+"&action=deletehouse",
					 success:function(data){
