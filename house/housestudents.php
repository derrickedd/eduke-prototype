...
<html lang="en">
<head>
     <title>Eduke - House Students</title>
...
<body>
	 ...
	 <script>
	     <?php
		 echo "function showHouseStudentList(){
			 $.ajax({
				 type:\"post\",
				 url:\"house-process-function.php\",
				 data:\"house_id=\"+$house_id+\"&action=showhousehtudentlist\",
				 success:function(data){
					 $(\"#list-results\").html(data);
				 }
			 });
		 }";
		 echo "showHouseStudentList();";
		 echo "function moreHouseStudentList(value){
			 $.ajax({
				 type:\"post\",
				 url:\"house-process-function.php\",
				 data:\"page=\"+value+\"&house_id=\"+$house_id+\"&action=showhousehtudentlist\",
				 success:function(data){
					 $(\"#list-results\").html(data);
				 }
			 });
