...
<html lang="en">
<head>
     <title>Eduke - Insert Marks</title>
     ...
     <div id="frame">
	     ...
	     <div id="navigation">
		     ...
		     <p class="exam-nav">
			     ...
			     <span class="extra-exam-nav">
				     ...
				     <a href="../exams/insertmarks.php" class="selected-nav">Insert Marks</a>
				 </span>
	     ...
	     <div id="content-reload">
			 <div id="boxlist-content">
			     <h1>INSERT MARKS</h1>
				 <p><img src="../../system/images/sys-nav/house-red.png" height="15px"> <b>Exams</b> / <b>Insert Marks</b></p>
				 
				 <div id="main">
				 <?php
						 
						 echo "<div id=\"selecting-pan\">";
						     echo "<div id=\"class-selection-pan\">";
							     $queryex = "SELECT class_id, class_alias FROM schoolclass ORDER BY class_id DESC";
								 ...
								 echo "<p><b>CLASS</b> <br> <select name=\"class_id\"><option>- Select Class -</option>";
								 for ($jex = 0 ; $jex < $rowsex ; ++$jex)
								 {
									 $rowex = mysql_fetch_row($resultex);
									 $class_id = $rowex[0];
									 $class_alias = $rowex[1];
								     echo "<option value=$class_id onclick=\"showSubClassPan($class_id)\">$class_alias</option>";
								 }
								 echo "</select></p>";
						     echo "</div>";
							 
						     echo "<div id=\"subclass-selection-pan\"></div>";
							 
						     echo "<div id=\"subject-selection-pan\"></div>";
						 
							 echo "<div id=\"term-selection-pan\"></div>";
