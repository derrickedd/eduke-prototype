...
<body>
     <div id="frame">
	     ...
	     <div id="navigation">
		     ...
		     <p class="exam-nav">
			     ...
			     <span class="extra-exam-nav">
				     ...
				     <a href="../exams/examtype.php" class="selected-nav">Set Exam Type</a>
				     <a href="../exams/insertmarks.php">Insert Marks</a>
				 </span>
			    <a href="../exams/exam.php" class="selected-nav"><img style="vertical-align:middle;" src="../../system/images/sys-nav/exam.png" height="15px" width="15px"> Exam</a></p>
		     <p class="fees-nav">
			     <img class="arrow" src="../../system/images/sys-nav/arrow.png" height="10px">
	     ...
	     <div id="content-reload">
		     <div id="boxlist-content">
				 <h1>EXAM TYPE</h1>
				 <p><b>Directory: Exams</b> / <b>Exam Types</b></p>
				 ...
				 <?php
					 echo "<div id=\"list-results\">";
							 echo "<p style=\"padding:10px;background-color:#456784;color:white;\">
									 ...
									 <span style=\"width:120px;\"><b>EXAM NAME</b></span>
									 <span style=\"width:170px;\"><b>EXAM ABREVIATION</b></span>
									 <span style=\"width:200px;\"><b>DESCRIPTION</b></span>
								 </p>";
								 ...
								 if(!$result) die("DB access failed(derro internal error): " . mysql_error());
								  ...
								  echo "<ul>";
									 ...
									 $exam_abreviation = $row['exam_abreviation'];
									 $description = $row['description'];
									 
									 echo "<li>
											 <span style=\"width:50px;\">$examtypes_id</span>
											 <span style=\"width:120px;\">$exam_name</span>
											 <span style=\"width:170px;\">$exam_abreviation</span>
											 ...
											 <input style=\"width:100px;background-color:#33333f;color:red;cursor:pointer;padding:5px;border-radius:3px;\" 
												 type=\"button\" value=\"Delete\" onclick=deleteExamType($examtypes_id)>
											 </span>
										 </li>";
									 }
								 echo "</ul>";
				 ...
				 <div id="addclass">
					 <form action="examtypeadded.php" id="form-content" method="POST" enctype="multipart/form-data">
						 <h3>CREATE EXAM TYPE</h3>
						 <p>EXAM NAME <br><input type="text" name="exam_name" required></p>
							 <p>EXAM ABREVATION <br><input type="text" name="exam_abreviation" required></p>
						 ...
						 type="submit" value="ADD EXAM TYPE"></p>
					 </form>
				 </div>
			 </div>
		 </div>
	 ...
	 <script>
		 function deleteExamType(examtypes_id){
			 if (confirm('Are you sure you want to delete the exam type?')) {
				 $.ajax({
					 type:"post",
					 url:"exam-process-function.php",
					 data:"examtypes_id="+examtypes_id+"&action=deleteexamtype",
