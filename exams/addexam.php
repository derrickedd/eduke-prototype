     ...
     <div id="frame">
	     ...
	     <div id="navigation">
		     ...
		     <p class="exam-nav">
			     ...
			     <span class="extra-exam-nav">
				     <a href="../exams/addexam.php" class="selected=nav">Add Exam</a>
	     ...
	     <div id="content-reload">
		     <div id="boxlist-content">
				 <h1>ADD EXAM</h1>
				 <p><b>Directory: Exams</b> / <b>Add Exam</b></p>

				 <div id="main">
					 <div id="addclass">
						 <form action="examadded.php" id="form-content" method="POST" enctype="multipart/form-data">
							 <h3>CREATE EXAM</h3>
								 <?php
									 ...
									 echo "<p>TERM: <br><select name=\"term_id\"><option value=\"NONE\">-Select Term-</option>";
									 for ($j = 0 ; $j < $rows ; ++$j)
									 {
										 $row = mysql_fetch_row($result);
										 echo "<tr>";
								 ...
								 ?>
								 <?php
									 $query = "SELECT examtypes_id, exam_abreviation FROM examtypes";
									 $result = mysql_query($query);
									 if(!$result) die("DB access failed(derro internal error): " . mysql_error());
									 $rows = mysql_num_rows($result);
									 
									 echo "<p>EXAM TYPE: <br><select name=\"examtypes_id\"><option value=\"NONE\">- Select Exam Type-</option>";
									 for ($j = 0 ; $j < $rows ; ++$j)
									 {
										 $row = mysql_fetch_row($result);
										 echo "<tr>";
										 for ($k = 0 ; $k < 1 ; ++$k)
											 $examtypes_id = $row[0];
											 $exam_abreviation = $row[1];
											 echo "<option value=$examtypes_id>$exam_abreviation</option>";
										 echo "</tr>";
									 }
									 echo "</select></p>";
								 ?>
								 <p style="width:250px!important;">EXAM DATE <br><select name="exam_month" style="width:110px!important;">
									 ...
									 <input type="text" name="exam_day" placeholder="Day" style="width:30px!important;" required>
									 <input type="text" name="exam_year" placeholder="Year" style="width:50px!important;" required>
								 </p>
								 <p>EXAM COMMENT: <br><input type="text" name="exam_comment"></p>
							 
							     <p><input style="background-color:green;border:solid 1px green!important;border-radius:3px;color:#fff;cursor:pointer;"
							     type="submit" value="Add Exam"></p>
						 </form>
					 </div>
