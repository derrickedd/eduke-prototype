     ...
     <div id="frame">
	     ...
	     <div id="navigation">
		     ...
		     <p class="parent-nav">
				 ...
				 <span class="extra-parent-nav">
				     <a href="../parent/addparent.php" class="selected-nav">Add Parent</a>
				 </span>
	     ...
	     <div id="content-reload">
			 <div id="boxlist-content">
			     <h1>ADD PARENTS</h1>
				 <p><b>Directory: Add Parents</b></p>
			     <div id="form-content">
					 <form action="parentadded.php" method="POST" enctype="multipart/form-data">
						 <div id="user-details">
						     <h3>PARENT DETAILS</h3>
							 <p>FIRST NAME: <br><input type="text" name="parent_firstname" required></p>
							 <p>LAST NAME: <br><input type="text" name="parent_lastname" required></p>
							 ...
							 <p><input style="background-color:green;color:#fff;border:solid 1px green!important;border-radius:3px;
						     padding:15px;cursor:pointer;" type="submit" value="Add Parent"></p>
						 </div>
					 </form>
		         </div>
			 </div>
