...
<html lang="en">
<head>
     <title>Eduke - Class Subjects</title>
...
<body>
     <div id="frame">
	     ...
	     <div id="content-reload">
			 <div id="boxlist-content">
				 ...
				 <p><b>Directory: Class Subjects</b></p>
				 
				 
				 <?php
				     if(isset($_GET['classlevel_id']) && isset($_GET['class_category_id']))
				     {
						 $classlevel_id = $_GET['classlevel_id'];
						 $class_category_id = $_GET['class_category_id'];
	 ...
	 <script>
	 <?php
	     echo "function showClassSubjectsList(classlevel_id, class_category_id){
			 $.ajax({
				 type:\"post\",
				 url:\"class-process-function.php\",
				 data:\"classlevel_id=\"+classlevel_id+\"&class_category_id=\"+class_category_id+\"&action=showclasssubjectslist\",
				 success:function(data){
					 $(\"#list-results\").html(data);
				 }
			 });
		 }
         showClassSubjectsList($classlevel_id, $class_category_id);";
	 ?>
	     
		 
		 function moreClassSubjectsList(value, classlevel_id, class_category_id){
			 $.ajax({
				 type:"post",
				 url:"class-process-function.php",
				 data:"page="+value+"&classlevel_id="+classlevel_id+"&class_category_id="+class_category_id+"&action=showclasssubjectslist",
				 success:function(data){
					 $("#list-results").html(data);
				 }
			 });
