...
<html lang="en">
<head>
     <title>Eduke - Class Students</title>
...
<body>
     <div id="frame">
	     ...
	     <div id="content-reload">			 
			 <div id="boxlist-content">
				 ...
				 <p><b>Directory: Class Students</b></p>
				 
			     <?php
				     if(isset($_GET['class_id']) && isset($_GET['sub_class_id']))
				     {
					 ...
					 echo "<div id=\"main\">
					 <div style=\"width:600px;margin-left:auto;margin-right:auto;\"><h1>SYSTEM ERROR</h1><br>
	 ...
	 <script>
	 <?php
	     echo "function showClassStudents(class_id, sub_class_id){
			 $.ajax({
				 type:\"post\",
				 url:\"class-process-function.php\",
				 data:\"class_id=\"+class_id+\"&sub_class_id=\"+sub_class_id+\"&action=showclassstudents\",
				 success:function(data){
					 $(\"#list-results\").html(data);
				 }
			 });
		 }
         showClassStudents($class_id, $sub_class_id);";
	 ?>
	     
		 
		 function moreClassStudents(value, class_id, sub_class_id){
			 $.ajax({
				 type:"post",
				 url:"class-process-function.php",
				 data:"page="+value+"&class_id="+class_id+"&sub_class_id="+sub_class_id+"&action=showclassstudents",
				 success:function(data){
					 $("#list-results").html(data);
				 }
			 });
		 ...
		 function promoteClassStudent(student_id, class_id, sub_class_id, id2){
			 var term_id = $("#"+id2).val();
			 ...
			 if(term_id == null){
				 ...
				 $.ajax({
					 type:"post",
					 url:"class-process-function.php",
					 data:"class_id="+class_id+"&sub_class_id="+sub_class_id+"&student_id="+student_id+"&term_id="+term_id+"&action=promotestudent",
					 success:function(data){
						 location.reload();
					 }
				 });
		 ...
		 function dePromoteClassStudent(student_id){

				 $.ajax({
					 type:"post",
					 url:"class-process-function.php",
					 data:"student_id="+student_id+"&action=depromotestudent",
					 success:function(data){
						 location.reload();
					 }
				 });
