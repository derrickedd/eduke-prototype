			 ...
			 <div id="boxlist-content">
				 ...
				 <div id="main">
					 ...
					 echo "<p style=\"padding:10px;background-color:#456784;color:white;\">
							 ...
							 <span style=\"width:200px;\"><b>CLASS NAME</b></span>
						 ...
						 echo "<ul>";
							 while($row=mysql_fetch_array($result)){
								 ...
								 $queryex = "SELECT COUNT(*) FROM schoolstudents WHERE class_id = '$class_id' AND status = 'Active'";
								 $resultex = mysql_query($queryex);
								 if(!$resultex) die("DB access failed(derro internal error): " . mysql_error());
								 $rowsex = mysql_num_rows($resultex);
								 for ($jex = 0 ; $jex < $rowsex ; ++$jex)
								 ...
								 echo "<li><a href=\"viewclass.php?class_id=$class_id\">
									 <span style=\"width:50px;\">$class_id</span>
									 <span style=\"width:200px;\">$class_alias</span>
