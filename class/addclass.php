     ...
     <div id="frame">
	     ...
	     <div id="navigation">
		     ...
		     <p class="class-nav">
			     ...
			     <span class="extra-class-nav">
				     <a href="../class/addclass.php" class="selected-nav">Add Class</a>
	     ...
	     <div id="content-reload">
		     <div id="boxlist-content">
			     <h1>CREATE CLASS</h1>
				 <p><img src="../../system/images/sys-nav/house-red.png" height="15px"> <b>Students</b> / <b>Add Class</b></p>
				 
				 <div id="main">
				     <div id="addclass">
						     <form action="classadded.php" id="form-content" method="POST" enctype="multipart/form-data">
							     <h3>ADD CLASS</h3>
								 <div class="form-left-content">
									 <p>CLASS NAME <br><input type="text" name="class_alias" required></p>
									 <?php
										 $query = "SELECT teacher_id,teacher_firstname,teacher_lastname FROM schoolteachers";
										 $result = mysql_query($query);
										 if(!$result) die("DB access failed(derro internal error): " . mysql_error());
										 $rows = mysql_num_rows($result);
										 
										 echo "<p>CLASS TEACHER: <br><select name=\"teacher_id\"><option value=\"NONE\">-Select Teacher-</option>";
										 for ($j = 0 ; $j < $rows ; ++$j)
										 {
											 $row = mysql_fetch_row($result);
											 echo "<tr>";
									 ...
									 <?php
										 ...
										 echo "<p>CLASS LEVEL: <br><select name=\"classlevel_id\"><option value=\"NONE\">-Select Class Level-</option>";
										 for ($j = 0 ; $j < $rows ; ++$j)
										 {
											 $row = mysql_fetch_row($result);
											 echo "<tr>";
									 ...
									 <?php
										 ...
										 echo "<p>CLASS CATEGORY: <br><select name=\"class_category_id\"><option value=\"NONE\">-Select Class Category-</option>";
										 for ($j = 0 ; $j < $rows ; ++$j)
										 {
											 $row = mysql_fetch_row($result);
											 echo "<tr>";
									 ...
									 border-radius:3px;cursor:pointer;" type="submit" value="Add Class"></p>
								 </div>
						     </form>
						 </div>
				 </div>
