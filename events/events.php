...
<body>
	 ...
	 <script>
	     function showEventsList(){
			 $.ajax({
				 type:"post",
				 url:"events-process-function.php",
				 data:"action=showeventslist",
		 ...
		 function moreEvents(value){
			 $.ajax({
				 type:"post",
				 url:"events-process-function.php",
				 data:"page="+value+"&action=showeventslist",
				 success:function(data){
					 $("#list-results").html(data);
				 }
			 });
		 ...
		 function deleteEvent(events_id){
			 if (confirm('Are you sure you want to delete the event?')) {
				 $.ajax({
					 type:"post",
					 url:"events-process-function.php",
					 data:"events_id="+events_id+"&action=deleteevent",
					 success:function(data){
						 location.reload();
					 }
				 });
