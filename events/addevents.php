     ...
     <div id="frame">
	     ...
	     <div id="navigation">
		     ...
		     <p class="events-nav">
				 ...
				 <span class="extra-events-nav">
				     <a href="../events/addevents.php" class="selected-nav">Add Event</a>
				 </span>
			     <a href="../events/events.php" class="selected-nav"><img style="vertical-align:middle;" src="../../system/images/sys-nav/events.png" height="15px" width="15px"> Events</a>
			 </p>
		     <p class="term-nav">
			     <img class="arrow" src="../../system/images/sys-nav/arrow.png" height="10px">
	     ...
	     <div id="content-reload">
		     <div id="boxlist-content">
			     <h1>CREATE EVENT</h1>
				 <p><img src="../../system/images/sys-nav/house-red.png" height="15px"> <b>Events</b> / <b>Create Event</b></p>
				 
				 
				 <div id="main">
				     <div id="addclass">
					     <h3>CREATE EVENT</h3>
						     <form action="eventsadded.php" id="form-content" method="POST" enctype="multipart/form-data">
									 <p>EVENTS NAME <br><input type="text" name="events_name" required></p>
									 <p>DESCRIPTION <br><input type="text" name="description" required></p>
									 <p style="width:250px!important;">EVENT DATE <br><select name="event_month" style="width:110px!important;">
									 ...
									 <input type="text" name="event_day" placeholder="Day" style="width:30px!important;" required>
									 <input type="text" name="event_year" placeholder="Year" style="width:50px!important;" required>
									 </p>
									 ...
									 <?php
										 ...
										 echo "<p>ACADEMIC TERM: <br><select name=\"academic_term_id\"><option value=\"NONE\">-Select Term-</option>";
										 for ($j = 0 ; $j < $rows ; ++$j)
										 {
											 $row = mysql_fetch_row($result);
											 echo "<tr>";
									 ...
									 border-radius:3px;cursor:pointer;" type="submit" value="Add Event"></p>
						     </form>
						 </div>
				 </div>
			 </div>
