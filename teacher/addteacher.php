     ...
     <div id="frame">
	     ...
	     <div id="navigation">
		     ...
		     <p class="teacher-nav">
			     ...
			     <span class="extra-teacher-nav">
				     <a href="../teacher/addteacher.php" class="selected-nav">Add Teacher</a>
				 </span>
			     <a href="../teacher/teacher.php" class="selected-nav"><img style="vertical-align:middle;" src="../../system/images/sys-nav/teacher.png" height="15px" width="15px"> Teacher</a>
			 </p>
		     <p class="class-nav">
			     <img class="arrow" src="../../system/images/sys-nav/arrow.png" height="10px">
	     ...
	     <div id="content-reload">
		     <div id="boxlist-content">
			     <h1>ADD TEACHER</h1>
				 <p><img src="../../system/images/sys-nav/house-red.png" height="15px"> <b>Teachers</b> / <b>Add Teacher</b></p>
				 
				 <div id="form-content">
					 <form action="teacheradded.php" method="POST" enctype="multipart/form-data">
						 <div id="teacher-details">
						     <h2>TEACHER DETAILS</h2>
							 <p>FIRST NAME: <br><input type="text" name="teacher_firstname" required></p>
							 <p>LAST NAME: <br><input type="text" name="teacher_lastname" required></p>
							 ...
							 <p>PHONE: <br><input type="text" name="phone" required></p>
							 <p>OTHER PHONE: <br><input type="text" name="phone_alt" ></p>
						 ...
						 <div style="text-align:center;clear:both;"><input style="background-color:green;color:#fff;border:solid 1px green;border-radius:3px;
						 padding:15px;cursor:pointer;" type="submit" value="ADD TEACHER"></div>
					 </form>
		         </div>
			 </div>
	     </div>
