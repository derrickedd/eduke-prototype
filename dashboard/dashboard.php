...
<body>
     <div id="frame">
	     ...
	     <div id="navigation">
			 <p class="dashboard-nav">
			     ...
			     <a href="../dashboard/dashboard.php" class="selected-nav"><img style="vertical-align:middle;" src="../../system/images/sys-nav/dashboard.png" height="15px" width="15px"> Dashboard</a>
			 </p>
		     <p class="student-nav">
			     <img class="arrow" src="../../system/images/sys-nav/arrow.png" height="10px">
	     ...
	     <div id="content-reload">
			 ...
			 <h1>DASHBOARD</h1>
				 <p><img src="../../system/images/sys-nav/house-red.png" height="15px"> <b>Dashboard</b></p>
			     
				 <div id="dashboardviewtab">
				 <?php 
				     $querycount = "SELECT COUNT(*) FROM schoolstudents";
					 ...
					 for ($j = 0 ; $j < $rowscount ; ++$j)
					 {
						...
						echo "<div id=\"dashboadview\" style=\"background-color:skyblue;\">
						     <p><img src=\"../../system/images/sys-nav/student-white.png\" height=\"40px\"> <b>$row[0]</b></p>
						     <p>TOTAL STUDENTS</p>
						</div>";
					 }
					 
					 $querycount = "SELECT COUNT(*) FROM schoolteachers";
					 $resultcount = mysql_query($querycount);
					 if(!$resultcount) die("DB access failed(derro internal error): " . mysql_error());
					 ...
					 {
						 $row = mysql_fetch_row($resultcount);
						 echo "<div id=\"dashboadview\" style=\"background-color:#543672;\">
						     <p><img src=\"../../system/images/sys-nav/teacher-white.png\" height=\"40px\"> <b>$row[0]</b></p>
						     <p>TOTAL TEACHERS</p>
						 </div>";
					 }
					 
					 $querycount = "SELECT COUNT(*) FROM schoolclass";
					 $resultcount = mysql_query($querycount);
					 if(!$resultcount) die("DB access failed(derro internal error): " . mysql_error());
					 ...
					 {
						 $row = mysql_fetch_row($resultcount);
						 echo "<div id=\"dashboadview\" style=\"background-color:#546782;\">
						     <p><img src=\"../../system/images/sys-nav/class-white.png\" height=\"40px\"> <b>$row[0]</b></p>
						     <p>TOTAL CLASSES</p>
						 </div>";
					 }
					 
					 $querycount = "SELECT COUNT(*) FROM schoolsubjects";
					 $resultcount = mysql_query($querycount);
					 if(!$resultcount) die("DB access failed(derro internal error): " . mysql_error());
					 ...
					 {
						 $row = mysql_fetch_row($resultcount);
						 echo "<div id=\"dashboadview\" style=\"background-color:#478290;\">
				 ...
				 <div>
				     <div id="noticedashboardbox">
					     <h3>NOTICES</h3>
						 <?php
						     $query = "SELECT * FROM noticeboard WHERE academic_term_id = '$academic_term_id'";
									 $result = mysql_query($query);
									 if(!$result) die("DB access failed(derro internal error): " . mysql_error());
									 ...
									 echo "<ul>";
										 while($row=mysql_fetch_array($result)){
											 ...
											 echo "<li>
											     <span style=\"width:100px;\">$date_of_notice</span>
												 <span><b style=\"width:280px;font-size:12px;background-color:#555;padding:5px;color:#fff;\">$notice_title</b><br>
												 <span style=\"padding:3px;\">$notice_message</span></span>
											 </li>";
										 }
									 echo "</ul>";
						 ?>
					 </div>
					 <div id="eventdashboardbox">
					     <h3>EVENTS</h3>
						 <?php
						     $query = "SELECT * FROM events WHERE academic_term_id = '$academic_term_id'";
									 $result = mysql_query($query);
									 if(!$result) die("DB access failed(derro internal error): " . mysql_error());
									 ...
									 echo "<ul>";
										 while($row=mysql_fetch_array($result)){
											 ...
											 echo "<li>
												 ...
												 <span><b style=\"width:280px;font-size:12px;background-color:#555;padding:5px;color:#fff;\">$events_name</b><br>
												 <span style=\"padding:3px;\">$description</span></span>
											 </li>";
										 }
									 echo "</ul>";
						 ?>
	 ...
	 <script>
		 jQuery(document).ready(function() {
			 ...
			 $("#add_notice_form_button").click(function(){
                 ...
                 if(notice_title == "" || notice_message == "")
				 {
					 ...
					 $.ajax({
					 type:"post",
					 url:"dashboard-process-function.php",
					 data:"notice_title="+notice_title+"&notice_message="+notice_message+"&action=addnotice",
