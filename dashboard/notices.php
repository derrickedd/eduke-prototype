...
<html lang="en">
<head>
     <title>Eduke - Managing Notices</title>
	    ...
	    <div id="navigation">
			 <p class="dashboard-nav">
			     ...
			     <span class="extra-dashboard-nav">
				     <a href="../dashboard/notices.php" class="selected-nav">Manage Notices</a>
				 </span>
	     ...
	     <div id="content-reload">
			 ...
			 <h1>NOTICES</h1>
				 <p><img src="../../system/images/sys-nav/house-red.png" height="15px"> <b>Notices</b></p>
				 ...
				 <div class="tabs">
					 ...
					 <div class="tab-content">
						 <div id="notices" class="tab active">
						     <div id="selecting-pan">
				     <?php
							 ...
							 for ($j = 0 ; $j < $rows ; ++$j)
							 {
								 ...
								 for ($k = 0 ; $k < 1 ; ++$k){
									 ...
									 $academic_year = $row[1];
									 $academic_term = $row[2];
									 echo "<option value='$term_id' onclick=showNotice($term_id);>$academic_year - $academic_term</option>";
								 }
							 }
							 echo "</select></p>";
						 ?>
						 ...
						 <div id="addnotice" class="tab">
						     <h2>ADD NOTICE</h2>
						     <div id="add-notice-form">
								 <p><input type="text" name="notice_title" id="notice_title" placeholder="Notice Title"></p>
								 <p><textarea style="width:260px;height:70px;" placeholder="Notice Message" name="notice_message" id="notice_message"></textarea></p>
								 <?php
									 $query = "SELECT academic_term_id,academic_year,academic_term FROM schoolterm";
									 $result = mysql_query($query);
									 if(!$result) die("DB access failed(derro internal error): " . mysql_error());
									 ...
									 echo "<p><select id=\"notice_term\"><option value=\"NONE\">-Select Term-</option>";
									 for ($j = 0 ; $j < $rows ; ++$j)
									 {
										 $row = mysql_fetch_row($result);
										 echo "<tr>";
									 ...
									 echo "</select></p>";
								 ?>
								 <p><input style="cursor:pointer;background-color:green;color:white;" 
									 type="button" value="Add Notice" id="add_notice_form_button"></p>
							 </div>
						 </div>
					 </div>
				 </div>
	 ...
	 <script>
		 jQuery(document).ready(function() {
			 ...
			 $("#add_notice_form_button").click(function(){
                 ...
                 var notice_term = $("#notice_term").val();
				 
                 if((notice_title == "") || (notice_message == "") || (notice_term == "NONE"))
				 {
					 /*Do nothing*/
				 } else {
					 $.ajax({
						 ...
						 data:"notice_title="+notice_title+"&notice_message="+notice_message+"&notice_term="+notice_term+"&action=addnotice",
