...
<body>
     <div id="frame">
	     ...
	     <div id="content-reload">
		     <div id="boxlist-content">
			     <h1>FEES OVERVIEW - ACADEMIC TERM WISE</h1>
				 <p style="padding:20px;"><b>Directory: Fees</b> / <b>Fees Overview</b> / <b>Academic term wise</b></p>
	 ...
	 <script>
		 function showFeesList(){
			 $.ajax({
				 type:"post",
				 url:"fees-process-function.php",
				 data:"action=showfeeslist",
		 ...
		 function moreFeesList(value){
			 $.ajax({
				 type:"post",
				 url:"fees-process-function.php",
				 data:"page="+value+"&action=showfeeslist",
				 success:function(data){
					 $("#list-results").html(data);
				 }
			 });
