     ...
     <div id="frame">
	     ...
	     <div id="content-reload">
			 <div id="boxlist-content">
			     <h1>FEE WAIVER</h1>
				 <p><img src="../../system/images/sys-nav/house-red.png" height="15px"> <b>Fee Waiver</b></p>
				 ...
				 <div id="main">
				     <?php
						 ...
						 echo "<div>
						     <p><b>SEARCH STUDENT</b> <br><input type=\"text\" id=\"search\" placeholder=\"Student Name\"></p>
						 </div>";
						 
						 echo "<div id=\"waiverpanselector\"></div>";
						 
						 echo "<div id=\"percentagepan\"></div>";
							 
						 echo "</div>
						 <div id=\"displaysearchstudentandmakepayment\"></div>";
         ...
         $("#search").keyup(function() {
			 ...
			 if (student_name == "") {
				 ...
				 $.ajax({
					 ...
					 data:"student_name="+student_name+"&action=searchstudentandaddfeewaiver",
