...
<html lang="en">
<head>
     <title>Eduke - Fee Waiver Details</title>
...
<body>
     <div id="frame">
	     ...
	     <div id="navigation">
		     ...
		     <p class="fees-nav">
				 ...
				 <span class="extra-fees-nav">
				     ...
				     <a href="../fees/feewaiver.php" class="selected-nav">Fee Waiver</a>
				 </span>
	     ...
	     <div id="content-reload">
			 <div id="boxlist-content">
				 <h1>FEE WAIVER DETAILS</h1>
				 <p><img src="../../system/images/sys-nav/house-red.png" height="15px"> <b>Fees</b> / <b>Fee Waiver Details</b></p>
				 ...
				 <?php
					 if(isset($_GET['student_id']))
					 {
						 ...
						 <p style=\"padding:5px;background-color:#456784;color:white;\">
							 <span style=\"width:150px;\"><b>TERMS</b></span>
							 <span style=\"width:150px;\"><b>PERCENTAGE OFF</b></span>
							 <span style=\"width:170px;\"><b>DESCRIPTION</b></span>
							 <span style=\"width:170px;\"><b>ACTIONS</b></span>
						 </p>";
							 
						 $query = "SELECT * FROM fee_waiver WHERE student_id = '$student_id'";
						 $result = mysql_query($query);
						 if(!$result) die("DB access failed(derro internal error): " . mysql_error());
						 ...
						 echo "<ul>";
							 ...
							 {
								 $fee_waiver_id = $row['fee_waiver_id'];
								 $description = $row['description'];
								 $fee_waiver_percentage = $row['fee_waiver_percentage'];
								 ...
								 for ($jex = 0 ; $jex < $rowsex ; ++$jex)
								 {
									 ...
									 $academic_year_check = $rowex[0];
									 $academic_term_check = $rowex[1];
								 }
								 /*END of Checking for admission_date*/
								 
								 echo "<li>
									 <span style=\"width:150px;\">$academic_year_check - $academic_term_check</span>
									 <span style=\"width:150px;\">$fee_waiver_percentage</span>
									 <span style=\"width:150px;\">$description</span>
									 <span>
                                         <input type=\"button\" value=\"Delete\" onclick=deleteFeeWaiver($fee_waiver_id);
										 style=\"background-color:black;color:red;border:solid 1px black;border-radius:3px;cursor:pointer;padding:5px;\">
									 </span>
								 </li>";
							 }
							 echo "</ul>
	 ...
	 <script>
	     function deleteFeeWaiver(fee_waiver_id){
			 if (confirm('Are you sure you want to delete fee waiver for this term?')) {
				 $.ajax({
					 type:"post",
					 url:"fees-process-function.php",
					 data:"fee_waiver_id="+fee_waiver_id+"&action=deletefeewaiver",
