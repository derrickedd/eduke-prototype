...
<html lang="en">
<head>
     <title>Eduke - Aprove Payments</title>
...
<body>
     <div id="frame">
	     ...
	     <div id="content-reload">
		     <div id="boxlist-content">
			     <h1>APROVE PAYMENTS- ACADEMIC TERM WISE</h1>
				 <p style="padding:20px;"><b>Directory: Fees</b> / <b>Aprove Payments</b> / <b>Academic term wise</b></p>
	 ...
	 <div id="footer">
	  ...
	  <script>
		 function showApprovePaymentList(){
			 $.ajax({
				 type:"post",
				 url:"fees-process-function.php",
				 data:"action=showapprovepaymentList",
				 success:function(data){
					 $("#list-results").html(data);
				 }
			 });
		 }
         showApprovePaymentList();
		 
		 function moreApprovePaymentList(value){
			 $.ajax({
				 type:"post",
				 url:"fees-process-function.php",
				 data:"page="+value+"&action=showapprovepaymentList",
				 success:function(data){
					 $("#list-results").html(data);
				 }
			 });
