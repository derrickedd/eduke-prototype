...
<body>
	 ...
	 <script>
	 <?php
	      echo "function showApprovePaymentStudentwise(){
			 $.ajax({
				 type:\"post\",
				 url:\"fees-process-function.php\",
				 data:\"academic_term_id=\"+$academic_term_id+\"&class_id=\"+$class_id+\"&action=showapprovepaymentstudentwise\",
				 success:function(data){
					 $(\"#list-results\").html(data);
				 }
			 });
		 }";
		 echo "showApprovePaymentStudentwise();";
		 echo "function moreApprovePaymentStudentwise(value){
			 $.ajax({
				 type:\"post\",
				 url:\"fees-process-function.php\",
				 data:\"academic_term_id=\"+$academic_term_id+\"&class_id=\"+$class_id+\"&page=\"+value+\"&action=showapprovepaymentstudentwise\",
				 success:function(data){
					 $(\"#list-results\").html(data);
				 }
			 });
