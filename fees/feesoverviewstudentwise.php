...
<body>
     <div id="frame">
	     ...
	     <div id="content-reload">	 
			 <div id="boxlist-content">
			     <h1>FEES OVERVIEW - STUDENT WISE</h1>
				 <p><b>Directory: Fees</b> / <b>Fees Overview</b> / <b>Student wise</b></p>
				 
				 <div id="main">
				 <?php
				     if(isset($_GET['academic_term_id']) && isset($_GET['class_id']))
				     {
	 ...
	 <script>
	 <?php
	      echo "function showOverviewStudentwise(){
			 $.ajax({
				 type:\"post\",
				 url:\"fees-process-function.php\",
				 data:\"academic_term_id=\"+$academic_term_id+\"&class_id=\"+$class_id+\"&action=showoverviewstudentwise\",
				 success:function(data){
					 $(\"#list-results\").html(data);
				 }
			 });
		 }";
		 echo "showOverviewStudentwise();";
		 echo "function moreOverviewStudentwise(value){
			 $.ajax({
				 type:\"post\",
				 url:\"fees-process-function.php\",
				 data:\"academic_term_id=\"+$academic_term_id+\"&class_id=\"+$class_id+\"&page=\"+value+\"&action=showoverviewstudentwise\",
				 success:function(data){
					 $(\"#list-results\").html(data);
				 }
			 });
