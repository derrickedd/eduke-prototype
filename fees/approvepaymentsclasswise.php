...
<html lang="en">
<head>
     <title>Eduke - Approve Payments Classwise</title>
     ...
     <div id="frame">
	     ...
	     <div id="content-reload">	 
			 <div id="boxlist-content">
			     <h1>APPROVE PAYMENT OVERVIEW - CLASS WISE</h1>
				 <p><b>Directory: Fees</b> / <b>Approve Payments</b> / <b>Class wise</b></p>
				 
				 <div id="main">
				 <?php
				     if(isset($_GET['academic_term_id']))
				     {
						 ...
						 while($row=mysql_fetch_array($result)){
							 ...
							 echo "<li><a href=\"approvepaymentsstudentwise.php?academic_term_id=$academic_term_id&class_id=$class_id\">
								 <span style=\"width:170px;\">$class_alias</span>";
