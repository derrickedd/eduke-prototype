...
<html lang="en">
<head>
     <title>Eduke - Make Payment</title>
     ...
     <div id="frame">
	     ...
	     <div id="navigation">
		     ...
		     <p class="fees-nav">
				 ...
				 <span class="extra-fees-nav">
				     <a href="../fees/makepayment.php" class="selected-nav">Make Payments</a>
	     ...
	     <div id="content-reload">
			 <div id="boxlist-content">
			     <h1>MAKE PAYMENT</h1>
				 <p><img src="../../system/images/sys-nav/house-red.png" height="15px"> <b>Fees</b> / <b>Make Payment</b></p>
         ...
         $("#search").keyup(function() {
			 ...
			 if (student_name == "") {
				 ...
				 $.ajax({
					 ...
					 data:"student_name="+student_name+"&action=searchstudentandmakepayment",
