...
<html lang="en">
<head>
     <title>Eduke - System Settings</title>
...
<body>
     <div id="frame">
	     ...
	     <div id="navigation">
		     ...
		     <p><a href="../settings/settings.php" class="selected-nav"><img style="vertical-align:middle;" src="../../system/images/sys-nav/settings.png" height="15px" width="15px"> Settings</a></p>
			 ...
			 <div id="boxlist-content">
			     ...
			     <div id="main">
				  <?php					 
						 ...
						 echo "<div style=\"display:inline-block;vertical-align:top;\" id=\"view-settings\">";
						 echo "<h3>SCHOOL DETAILS</h3>";
						 echo "<p><b>NAME</b> <br><input type=\"text\" value=\"$row[1]\" id=\"school_name\"></p>";
						 echo "<p><b>ADDRESS</b> <br><input type=\"text\" value=\"$row[2]\" id=\"school_address\"></p>";
						 echo "<p><b>P.O. BOX</b> <br><input type=\"text\" value=\"$row[3]\" id=\"school_po_box\"></p>";
						 echo "<p><b>PHONE</b> <br><input type=\"text\" value=\"$row[4]\" id=\"school_phone\"></p>";
						 echo "<p><b>OTHER PHONE</b> <br><input type=\"text\" value=\"$row[5]\" id=\"school_phone_alt\"></p>";
						 echo "<p><b>CODE</b> <br><input type=\"text\" value=\"$row[6]\" id=\"school_code\"> </p>";
						 echo "<p><b>EMAIL</b> <br><input type=\"text\" value=\"$row[7]\" id=\"school_email\"> </p>";
						 echo "<p><b>OTHER MAIL</b> <br><input type=\"text\" value=\"$row[8]\" id=\"school_email_alt\"> </p>";
						 echo "<p><b>WEBSITE</b> <br><input type=\"text\" value=\"$row[9]\" id=\"school_website\"> </p>";
						 echo "<p><b>MOTO</b> <br><input type=\"text\" value=\"$row[11]\" id=\"school_moto\"> </p>";
						 echo "<p><b>NUMBER OF TERMS</b> <br><input type=\"text\" value=\"$row[12]\" id=\"number_of_terms\"> </p>";
						 echo "<p><input type=\"button\" value=\"Save\" style=\"cursor:pointer;border:solid 1px green;border-radius:3px;
						 background-color:green;color:white;\" onclick=saveSettingsData()></p>";
						 echo "</div>";
						 ...
						 <h3>SCHOOL BADGE</h3>";
							 ...
							 {
								 $photo = "";
								 echo "<img src=\"../../system/images/school-logo/default.jpg\" width=\"300\">";
							 } 
							 elseif ($row[10] == "default")
							 {
								 $photo = "";
								 ...
								 $photo = $row[10];
								 echo "<input type=\"button\" value=\"Delete Photo\" onclick=deleteSchoolPhoto()
								 style=\"position:absolute;cursor:pointer;padding:10px;background-color:#bc3226;border:solid 1px #bc3226;
								 border-radius:3px;color:#fff;width:100px;\"> <img src=\"$row[10]\" width=\"300\">";
							 }
							 /*echo "$row[10]";*/
							 echo "<form action=\"uploadphoto.php?school_id=$row[0]\" method=\"POST\" enctype=\"multipart/form-data\">
						 ...
						 echo "<div id=\"backupbox\">
						 <h3>BACK UP</h3>
						     <p>
							     <a style=\"background-color:green;\" href=\"../backup/restore.php\">Restore backed data</a>
							     <a style=\"background-color:#bc3226;\" href=\"../backup/backup.php\">Click to back up</a> 
							 </p>
						 </div>";
						 
						 echo "<div id=\"softwareinfo\">
	 ...
	 <script>
		 <?php
		 echo "function deleteSchoolPhoto(){
			 ...
			 if (confirm('Are you sure you want to delete the photo?')) {
				 ...
				 $.ajax({
					 type:\"post\",
					 url:\"settings-process-function.php\",
					 data:\"photo=\"+photo+\"&school_id=\"+$row[0]+\"&action=deleteschoolphoto\",
		 ...
		 echo "function saveSettingsData(){
			 var school_name = $(\"#school_name\").val();
			 var school_address = $(\"#school_address\").val();
			 var school_po_box = $(\"#school_po_box\").val();
			 var school_phone = $(\"#school_phone\").val();
			 var school_phone_alt = $(\"#school_phone_alt\").val();
			 var school_code = $(\"#school_code\").val();
			 var school_email = $(\"#school_email\").val();
			 var school_email_alt = $(\"#school_email_alt\").val();
			 var school_website = $(\"#school_website\").val();
			 var school_moto = $(\"#school_moto\").val();
			 var number_of_terms = $(\"#number_of_terms\").val();
			 
			 $.ajax({
				 type:\"post\",
				 url:\"settings-process-function.php\",
				 data:\"school_name=\"+school_name+\"&school_address=\"+school_address+\"&school_po_box=\"+school_po_box+
				 \"&school_phone=\"+school_phone+\"&school_phone_alt=\"+school_phone_alt+\"&school_code=\"+school_code+
				 \"&school_email=\"+school_email+
				 \"&school_email_alt=\"+school_email_alt+\"&school_website=\"+school_website+\"&school_moto=\"+school_moto+\"&number_of_terms=\"+number_of_terms+
				 \"&school_id=\"+$row[0]+\"&action=savesettingsdata\",
				 success:function(data){
					 location.reload();
				 }
			 });
