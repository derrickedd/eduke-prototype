...
<html lang="en">
<head>
     <title>Eduke - Student Fees Details</title>
...
<body>
	    ...
	    <div id="status">
	     ...
	     <div id="content-reload">
			 <div id="boxlist-content">
				 ...
				 <p><img src="../../system/images/sys-nav/house-red.png" height="15px"> <b>Students</b> / <b>Details</b> / <b>Fees</b></p>
				 ...
				 <?php
				     if(isset($_GET['student_id']) && isset($_GET['class_id']) || isset($_GET['admission_academic_term_id']))
				     {
						 ...
						 if (isset($_GET['admission_academic_term_id'])){
						 ...
						 echo "<div id=\"selecting-pan\">";
							 echo "<div id=\"term-selection-pan\">";
							     echo "<p><b>ACADEMIC TERM</b> <br> <select name=\"academic_term_id\"><option value=\"NONE\">- Select Term -</option>";
								 for ($jq = 0 ; $jq < $rowsq ; ++$jq)
								 {
									 ...
									 for ($jex = 0 ; $jex < $rowsex ; ++$jex)
									 {
										 ...
										 echo "<option value=\"$term_id\" onclick=\"showFeesDetails($student_id, $class_id, $term_id)\">$academic_year - $academic_term</option>";
								     }
								 }
							 ...
							 echo "<div>
							 <a href=\"../fees/feewaiverdetails.php?student_id=$student_id\" target=\"_blank\" style=\"background-color:green;padding:10px;
							 vertical-align:middle;text-decoration:none;border:solid 1px green;border-radius:3px;color:#fff;cursor:pointer;\">Fee Waiver Details</a>
							 </div>";
							 
						 echo "</div>";
						 
						 echo "<div id=\"showfeesdetails\"></div>";
					 }
					 else {
	 ...
	 <div id="footer">
	  ...
	  <script>
	     <?php
		     echo "showFeesDetails($student_id, $class_id, $admission_academic_term_id);";
		 ?>
     </script>
     <noscript>
