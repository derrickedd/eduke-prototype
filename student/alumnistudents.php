...
<html lang="en">
<head>
     <title>Eduke - Student List</title>
     ...
     <div id="frame">
	     ...
	     <div id="navigation">
		     ...
		     <p class="student-nav">
			     ...
			     <span class="extra-student-nav">
				     ...
				     <a href="../student/alumnistudents.php" class="selected-nav">Alumni Students</a>
	     ...
	     <div id="content-reload">
			 <div id="boxlist-content">
				 ...
				 <p><img src="../../system/images/sys-nav/house-red.png" height="15px"> <b>Alumni Students</b></p>
				 ...
				 <div id="buttons">
				     <?php
						 ...
						 echo "<select name=\"class_id_search_selection\" id=\"class_id_search_selection\"><option
						 onclick=showStudentList('Alumni') >- Search By Class -</option>";
						 for ($j = 0 ; $j < $rows ; ++$j)
						 {
							 $row = mysql_fetch_row($result);
							 echo "<tr>";
							 for ($k = 0 ; $k < 1 ; ++$k)
							 echo "<option value=$row[0] onclick=displayStudentResultByID(this,'Alumni')>$row[1]</option>";
							 echo "</tr>";
						 }
						echo "</select>";
				     ?>
					 <input type="text" placeholder="Search Student" id="search_alumni_student" name="search_alumni_student" value="">
				 </div>
