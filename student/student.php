     ...
     <div id="frame">
	     ...
	     <div id="content-reload">
			 <div id="boxlist-content">
			     <h1>STUDENTS</h1>
				 <p><img src="../../system/images/sys-nav/house-red.png" height="15px"> <b>Students</b></p>
				 ...
				 <div id="buttons">
				     <?php
						 ...
						 onclick=showStudentList('Active') >- Search By Class -</option>";
						 for ($j = 0 ; $j < $rows ; ++$j)
						 {
							 $row = mysql_fetch_row($result);
							 echo "<tr>";
							 for ($k = 0 ; $k < 1 ; ++$k)
							 echo "<option value=$row[0] onclick=displayStudentResultByID(this,'Active')>$row[1]</option>";
							 echo "</tr>";
						 }
						echo "</select>";
				     ?>
					 <input type="text" placeholder="Search Student" id="search_active_student" name="search_active_student" value="">
				 </div>
